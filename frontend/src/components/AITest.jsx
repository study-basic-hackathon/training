...
const AITest = () => {
    ...
    const [formData, setFormData] = useState({
        ...
        end_date: new Date().toISOString().split('T')[0]   // 今日の日付をデフォルトに
    });
    ...
    const handleAutoFill = () => {
        ...
        setFormData({
            name: `自動入力プラン ${dateTimeString}`, // 今日の日付と現在の時刻を追加
            exercises: "週3回の筋力トレーニング（全身）、週2回の有酸素運動（ジョギング）",
            goal: "体重を5kg減らし、体脂肪率を3%下げる。基礎体力を向上させ、疲れにくい体を作る。",
            frequency: "週5回（筋トレ3回、有酸素運動2回）",
